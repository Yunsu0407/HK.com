        ...
        <main>
            <div class="product-container">
                ...
                <div class="product-details">
                    ...
                    <!-- 옵션 선택 -->
                    <label for="product-option">Layered Top</label>
                    <select id="product-option" class="product-option">
                    ...
                    <p class="total-price"><strong>10,900 WON</strong> (<span id="total-quantity">1</span>개)</p>
            ...
            <div class="tab-container">
                ...
                <div id="details" class="tab-content active">
                    ...
                    <p>긴 길이와 옆트임으로 활용도 높은 레이어드 탑 티셔츠입니다. 베이직한 디자인과 긴 길이로 다양한 스타일에 레이어드하여 활용하기에 좋습니다. 
                        <strong>코튼 100% 코마사 30수 싱글 저지원단</strong>을 사용하여 편안한 착용감을 제공합니다.</p>
                    <p>일반 스탠다드 티셔츠보다 밀단이 길며, 레이어드용으로 적합한 티셔츠입니다. 일반 티셔츠, 교복, 셔츠 등에 자유롭게 레이어드 가능합니다.</p>
                </div>
